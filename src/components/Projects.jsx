    ...
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div>
        {PROJECTS.map((project, index) => (
          <div key={index} className="mb-10 flex flex-wrap lg:justify-center lg:items-start">
            <motion.div
            ...
            >
              <img
                ...
                height={250}
                alt={project.title}
                className="mb-6 rounded lg:mr-20"
              />
            </motion.div>
            <motion.div
              whileInView={{ opacity: 1, x: 0 }}
              initial={{ opacity: 0, x: 100 }}
              transition={{ duration: 1 }}
              className="w-full max-w-xl lg:w-3/4 "  // Added lg:ml-8 for more space
            >
